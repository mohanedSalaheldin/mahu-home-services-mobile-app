      ...
      body: BlocConsumer<AuthCubit, AuthState>(
        listener: (context, state) {
          if (state is ForgotPasswordSucessededState) {
            showCustomSnackBar(
              context: context,
              message: S.of(context).forgetPasswordScreenSuccessMessage,
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      S.of(context).forgetPasswordScreenTitle,
                    ...
                    CustomTextField(
                      label:
                          S.of(context).forgetPasswordScreenEmailOrPhoneLabel,
                      hint: S.of(context).forgetPasswordScreenEmailOrPhoneHint,
                    ...
                    AppFilledButton(
                      ...
                      text: S.of(context).forgetPasswordScreenSendCodeButton,
                    ),
                  ],
                ),
              ),
